				...
				<div class="entry-content container gutters">
					...
					<div class="services row container gutters">
							...
							<div class="col span_3">
								...
								<p class="text-white">The Network consists of a free weekly resource for enhancing your leadership and ministry emailed directly to you.</p>
							</div>
							...
							<div class="col span_3">
								...
								<p class="text-white">The Inner Circle is a members-only online community designed to give church leaders the motivation, training, and resources to lead better.</p>
							</div>
							...
							<div class="col span_3">
								...
								<p class="text-white">Our personal coaching is designed specifically to help you gain understanding, navigate challenges, and hone your craft to the highest level possible.</p>
							</div>
							...
							<div class="col span_3">
								...
								<p class="text-white">Our customized consulting provides you personal interaction with our team (including onsite visits) to uniquely help you strengthen your ministry.</p>
							</div>
						</div>
