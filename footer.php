	...
	<nav class="nav-main clear">
		<div class="container">
			...
			<div class="menu col span_8">
				<ul class="menu">
					<li class="menu-item social-icons"><a href="#"><img src="/wp-content/uploads/2015/04/facebook1.png"  width="30px" /></a></li>
					<li class="menu-item social-icons"><a href="#"><img src="/wp-content/uploads/2015/04/twitter.png"  width="30px" /></a></li>
				</ul>
